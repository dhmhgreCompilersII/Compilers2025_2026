...
namespace CParser {
    ...
    public class TranslationUnitAST : ASTComposite {
        ...
        public enum NodeTypes {
            ...
            FLOAT_TYPE, DOUBLE_TYPE, CONST_TYPE, VOLATILE_TYPE,
            AUTO_TYPE, REGISTER_TYPE, STATIC_TYPE, EXTERN_TYPE,STRUCT_TYPE,UNION_TYPE,ENUM_TYPE, ARRAY_DECLARATOR, PARAMETER_DECLARATION,
    ...
    public class ConstTypeAST : ASTLeaf
    {
        public ConstTypeAST(string lexeme) : base(lexeme, (uint)TranslationUnitAST.NodeTypes.CONST_TYPE, lexeme) { }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO))
        {
            return visitor.VisitConstType(this, info);
        }
        protected override void SetNodeTypeName(string name)
        {
            base.SetNodeTypeName($"TYPE_QUALIFIER_{name}");
        }
    }

    public class VolatileTypeAST : ASTLeaf
    {
        public VolatileTypeAST(string lexeme) : base(lexeme, (uint)TranslationUnitAST.NodeTypes.VOLATILE_TYPE, lexeme) { }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO))
        {
            return visitor.VisitVolatileType(this, info);
        }
        protected override void SetNodeTypeName(string name)
        {
            base.SetNodeTypeName($"TYPE_QUALIFIER_{name}");
    ...
    public class AutoTypeAST : ASTLeaf
    {
        public AutoTypeAST(string lexeme) : base(lexeme, (uint)TranslationUnitAST.NodeTypes.AUTO_TYPE, lexeme) { }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO))
        {
            return visitor.VisitAutoType(this, info);
        }
        protected override void SetNodeTypeName(string name)
        {
            base.SetNodeTypeName($"STORAGE_SPECIFIER_{name}");
        }
    }

    public class RegisterTypeAST : ASTLeaf
    {
        public RegisterTypeAST(string lexeme) : base(lexeme, (uint)TranslationUnitAST.NodeTypes.REGISTER_TYPE, lexeme) { }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO))
        {
            return visitor.VisitRegisterType(this, info);
        }
        protected override void SetNodeTypeName(string name)
        {
            base.SetNodeTypeName($"STORAGE_SPECIFIER_{name}");
    ...
    public class StaticTypeAST : ASTLeaf
    {
        public StaticTypeAST(string lexeme) : base(lexeme, (uint)TranslationUnitAST.NodeTypes.STATIC_TYPE, lexeme) { }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO))
        {
            return visitor.VisitStaticType(this, info);
        }
        protected override void SetNodeTypeName(string name)
        {
            base.SetNodeTypeName($"STORAGE_SPECIFIER_{name}");
    ...
    public class ExternTypeAST : ASTLeaf
    {
        public ExternTypeAST(string lexeme) : base(lexeme, (uint)TranslationUnitAST.NodeTypes.EXTERN_TYPE, lexeme) { }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO))
        {
            return visitor.VisitExternType(this, info);
        }
        protected override void SetNodeTypeName(string name)
        {
            base.SetNodeTypeName($"STORAGE_SPECIFIER_{name}");
    ...
    public class StructTypeAST : ASTComposite {
        public const int STRUCT_NAME = 0, STRUCT_DECLARATIONS = 1;
        public StructTypeAST() :
            base(2, (uint)TranslationUnitAST.NodeTypes.STRUCT_TYPE, "StructTypeAST") {
        }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO)) {
    ...
    public class UnionTypeAST : ASTComposite {

        public const int UNION_NAME = 0, UNION_DECLARATIONS = 1;
        public UnionTypeAST() :
            base(2, (uint)TranslationUnitAST.NodeTypes.UNION_TYPE, "UnionTypeAST") {
        }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO)) {
    ...
    public class EnumTypeAST : ASTComposite {
        public const int ENUM_NAME = 0, ENUMERATORS = 1;
        public EnumTypeAST() :
            base(2,(uint)TranslationUnitAST.NodeTypes.ENUM_TYPE, "EnumTypeAST") {
        }
        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO)) {
    ...
    public class ArrayTypeAST : ASTComposite
    {
        public const int ARRAY_TARGET = 0, ARRAY_SIZE = 1;

        public ArrayTypeAST() :
            base(2, (uint)TranslationUnitAST.NodeTypes.ARRAY_DECLARATOR, "ArrayTypeAST")
        {
        }

        public override Result Accept<Result, INFO>(BaseASTVisitor<Result, INFO> visitor, INFO info = default(INFO))
        {
            return visitor.VisitArrayType(this, info);
        }
    }

...
namespace CParser
{
    ...
    public class TranslationUnitAST : ASTComposite
    {
        ...
        public enum NodeTypes
        {
            ...
            EXPRESSION_ADDITION = 13 , POSTFIX_EXPRESSION_ARRAYSUBSCRIPT = 21, 
            POSTFIX_EXPRESSION_FUNCTIONCALLNOARGS = 22,POSTFIX_EXPRESSION_FUNCTIONCALLWITHARGS = 23, 
            POSTFIX_EXPRESSION_MEMBERACCESS = 24,POSTFIX_EXPRESSION_POINTERMEMBERACCESS = 25, 
            POSTFIX_EXPRESSION_INCREMENT = 26,POSTFIX_EXPRESSION_DECREMENT = 27, 
            EXPRESSION_COMMAEXPRESSION = 28, 
